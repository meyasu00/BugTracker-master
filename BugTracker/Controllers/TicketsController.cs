    ...
    public class TicketsController : Controller
    {
        ...
        public async Task<bool> NotifyDeveloper(int ticketId, string editorId, string assigneeId)
        {
            ...
            if(user != null && ticket != null && developer != null) { 
                ...
                msg.Body = user.FullName + " has modified the ticket '" + ticket.Title + "'. To view this ticket, please visit https://meyasu-bugtracker.azurewebsites.net/Tickets/Details/" + ticket.Id + " If you have any questions, " + user.FullName + " can be contacted at " + user.Email;
                await svc.SendAsync(msg);
            }
